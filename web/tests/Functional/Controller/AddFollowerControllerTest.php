...
class AddFollowerControllerTest extends ApiTestCase
{
    ...
    public function testWhenUserAlreadyFollowArtist(): void
    {
        $this->databaseTool->loadFixtures([TwoUserWithArtistAndSongFixtures::class]);
    ...
    public function testWhenArtistNotFound(): void
    {
        ...
        $this->getRequestAddFollower($client, 'artist-truc', $token);
    ...
    public function testWhenNoAuthenticated(): void
    {
        ...
        $this->getRequestAddFollower($client, 'artist-1', '');
